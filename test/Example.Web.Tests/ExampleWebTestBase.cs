...
{
    public abstract class ExampleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ExampleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ExampleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ExampleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ExampleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ExampleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ExampleDbContext, Task<T>> func)
        {
            T result;
